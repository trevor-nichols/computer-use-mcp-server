...
import {
  ...
  listGrantedApplicationsOutputSchema,
  openApplicationOutputSchema,
...
export function createToolDefinitions(runtime: ServerRuntime): ToolDefinition[] {
  return [
    ...
    },
    {
      ...
      outputSchema: selectDisplayOutputSchema,
    ...
    },
    {
      ...
      inputSchema: { type: 'object', additionalProperties: false },
      outputSchema: cursorPositionOutputSchema,
      annotations: readonlyAnnotations(),
    ...
    },
    {
      ...
      outputSchema: pointOutputSchema,
    ...
    },
    {
      ...
      outputSchema: holdKeyOutputSchema,
      annotations: mutatingAnnotations(),
    ...
    },
    {
      ...
      inputSchema: { type: 'object', additionalProperties: false },
      outputSchema: clipboardOutputSchema,
      annotations: readonlyAnnotations(),
    ...
    },
    {
      ...
      outputSchema: openApplicationOutputSchema,
      annotations: mutatingAnnotations(),
    ...
    },
    {
      ...
      inputSchema: { type: 'object', additionalProperties: false },
      outputSchema: listGrantedApplicationsOutputSchema,
      annotations: readonlyAnnotations(),
    ...
    },
    {
      ...
      outputSchema: computerBatchOutputSchema,
      annotations: mutatingAnnotations(),
